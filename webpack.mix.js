...
mix
  .setPublicPath('_src/assets')
  .js('_src/_resources/js/app.js', 'js/')
  .sass('_src/_resources/scss/app.scss', 'css/')
  .browserSync({
    open: false,
    proxy: false,
    server: {
    ...
    files: ['_pages/**/*.html', '_dist/**/*.js', '_dist/**/*.css']
  })
  .disableNotifications()
  .then(function () {
    const manifest = fs.readJsonSync('_src/assets/mix-manifest.json')
